...
import { htmlToBlocks } from "./markup.js";
...
export const NotificationDialog = GObject.registerClass(
  class NotificationDialog extends ModalDialog.ModalDialog {
    ...
    _init(n, actions) {
      ...
      const meta = [n.actor || n.reason].filter(Boolean).join(" · ");
      if (meta) box.add_child(new St.Label({ text: meta, style_class: "opn-dialog-meta" }));
